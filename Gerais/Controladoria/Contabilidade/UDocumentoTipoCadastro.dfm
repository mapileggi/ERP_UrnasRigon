inherited FDocumentoTipoCadastro: TFDocumentoTipoCadastro
  ...
  inherited sbDados: TScrollBox
    ...
    object lbdeDocumentoTipo: TLabel
      Left = 45
      Top = 33
      Width = 50
      Height = 13
    ...
    object eddeDocumentoTipo: TDBEdit
      Left = 97
      Top = 30
      Width = 343
      Height = 21
      DataField = 'deDocumentoTipo'
    ...
    object edcdDocumentoTipo: TDBCampoCodigo
      ...
      ERPCampoDescricao = 'cdDocumentoTipo'
